...
public class PdfService {
    ...
    public Resource generatePdf(Integer trainingId) throws IOException {
        ...
        User user = userRepository.findRealnameByuId(train.getInspectorId());
        ...
        Paragraph content2 = new Paragraph("    于 " + currentDate + " 完成 " + standard.getsName() + " ，" + project.getpNum() + " ，" + project.getpName() + " 项目培训，获得该项目检测授权。")
                .setFont(font)
                .setFontSize(22)
                .setFontColor(ColorConstants.BLACK)
                .setTextAlignment(TextAlignment.LEFT);
